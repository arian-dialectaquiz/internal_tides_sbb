...
# =============================================================================
FILENAME   = '/Users/piero/arian/data1/nc_outs/avg_paper_3_tides_wind.nc'  # grid ds (dx, dy, dz)
S_PATH     = '/Users/piero/arian/data1/IT_outs/velocity/'                  # velocity files
OUT_DIR    = '/Users/piero/arian/data1/IT_outs/CG/'                        # where to save Pi
OUT_TAG    = 'wind'          # tag in the output filename
...
for i in range(1,len(eta_edges) - 1):
